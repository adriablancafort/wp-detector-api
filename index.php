...
function detect_themes($html, $wpContent) {
    // Returns a list of the themes detected in the html content
    /*
    Structure:
...
function detect_themes($html, $wpContent) {
    // Returns a list of the plugins detected in the html content
    /*
    Structure:
...
function top_themes() {
    // Returns a list of the most common themes
...
function top_plugins() {
    // Returns a list of the most common plugins
